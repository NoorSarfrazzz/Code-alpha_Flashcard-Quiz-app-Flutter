...
import 'package:flashcard_quiz/modal/GeneralKModal.dart';
import 'package:flashcard_quiz/modal/RandomModal.dart';
import 'package:flashcard_quiz/modal/ScienceModal.dart';
import 'package:flashcard_quiz/modal/HistoryModal.dart';
import 'package:flashcard_quiz/modal/VideoGamesModal.dart';
import 'package:flashcard_quiz/modal/GeographyModal.dart';
import 'package:flashcard_quiz/modal/SportsModal.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        backgroundColor: const Color(0xFF142A70),
        leading: Image.asset('assets/images/appbar-icon.png'),
        title: Text(widget.category, style: const TextStyle(color: Colors.white, fontSize: 16)),
      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_isAnswered)
                    ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(const Color(0xFF142A70)),
                      ),
